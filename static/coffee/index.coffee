...
Hs.xialiwei_waterfall_layout_items_load=(cards_dom,cards_width=500,cards_height=500,column=2,item_data_index=0)->
    ...
    for item_data in Hs.xialiwei_waterfall_layout_items_data.slice(items_num_need)
...
$ ->
    ...
    $(".xialiwei_waterfall_layout_item_cards").on "scroll",(evt)->
        console.log "scroll",evt
        if is_scroll_load_xialiwei_waterfall_layout_item_cards_has_first
            if not is_scroll_load_xialiwei_waterfall_layout_item_cards_has_second
        ...
        if not is_scroll_load_xialiwei_waterfall_layout_item_cards_has_first
        ...
        if not is_scroll_load_xialiwei_waterfall_layout_item_cards and is_scroll_load_xialiwei_waterfall_layout_item_cards_has_second
            ...
            for item_data in Hs.base_demo_data
